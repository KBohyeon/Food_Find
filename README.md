...
- Repository
  ...
  UploadRepository.java의 검색 기능만 JPQL 사용 이외 모든 Repository는 JPA 사용</br>
  
  이유: 키워드 검색 쿼리는 단순한 문자열 매칭이므로 JPQL이 적합하며 유지보수가 쉽다고 생각하였고</br>
        나머지 기능은 간단한 CRUD작업이기에 JPA를 사용하였습니다.
---
